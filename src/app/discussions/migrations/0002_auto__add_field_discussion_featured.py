...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.featured'
        db.add_column(u'discussions_discussion', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discussion.featured'
        db.delete_column(u'discussions_discussion', 'featured')
