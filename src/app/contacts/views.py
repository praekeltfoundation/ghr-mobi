...
class ContactCategories(core_mixins.GroupRequiredMixin, generic_views.ListView):
    groups_required = ['Ambassadors', 'Ni Nyampinga Journalists']
    
    def get_queryset(self):
        return models.ContactCategory.objects.permitted()
    
class ContactCategory(core_mixins.GroupRequiredMixin, core_views.ListWithDetailView):
    groups_required = ['Ambassadors', 'Ni Nyampinga Journalists']
