...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'articles_article', 'summary', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Article.summary'
        db.alter_column(u'articles_article', 'summary', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        u'articles.article': {
            ...
            'poll': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['poll.PollQuestion']", 'null': 'True', 'blank': 'True'}),
