...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExpertOpinion'
        db.create_table(u'experts_expertopinion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('expert_opinion_text', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('poll', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['poll.PollQuestion'], unique=True)),
        ))
        db.send_create_signal(u'experts', ['ExpertOpinion'])


    def backwards(self, orm):
        # Deleting model 'ExpertOpinion'
        db.delete_table(u'experts_expertopinion')
    ...
    models = {
        ...
        u'experts.expertopinion': {
            'Meta': {'object_name': 'ExpertOpinion'},
            'expert_opinion_text': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'poll': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['poll.PollQuestion']", 'unique': 'True'})
        },
