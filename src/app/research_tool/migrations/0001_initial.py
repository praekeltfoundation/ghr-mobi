...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResearchTool'
        db.create_table(u'research_tool_researchtool', (
        ...
        db.send_create_signal(u'research_tool', ['ResearchTool'])

        # Adding M2M table for field polls on 'ResearchTool'
        m2m_table_name = db.shorten_name(u'research_tool_researchtool_polls')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('researchtool', models.ForeignKey(orm[u'research_tool.researchtool'], null=False)),
            ('pollquestion', models.ForeignKey(orm[u'poll.pollquestion'], null=False))
        ))
        db.create_unique(m2m_table_name, ['researchtool_id', 'pollquestion_id'])


    def backwards(self, orm):
        # Deleting model 'ResearchTool'
        db.delete_table(u'research_tool_researchtool')

        # Removing M2M table for field polls on 'ResearchTool'
        db.delete_table(db.shorten_name(u'research_tool_researchtool_polls'))
    ...
    models = {
        ...
        u'authentication.enduser': {
            ...
            'day': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
            ...
            'month': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
        ...
        u'research_tool.researchtool': {
            'Meta': {'ordering': "['order', '-publish_at']", 'object_name': 'ResearchTool', '_ormbases': [u'core.ContentModel']},
            u'contentmodel_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.ContentModel']", 'unique': 'True', 'primary_key': 'True'}),
            'polls': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['poll.PollQuestion']", 'symmetrical': 'False'})
        },
        u'sites.site': {
