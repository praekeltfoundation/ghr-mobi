...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EndUser.about_me'
        db.add_column(u'authentication_enduser', 'about_me',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EndUser.is_special_guest'
        db.add_column(u'authentication_enduser', 'is_special_guest',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EndUser.about_me'
        db.delete_column(u'authentication_enduser', 'about_me')

        # Deleting field 'EndUser.is_special_guest'
        db.delete_column(u'authentication_enduser', 'is_special_guest')
