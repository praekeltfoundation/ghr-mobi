...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'root_visitor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unique', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'root', ['Visitor'])

        # Adding model 'PageImpression'
        db.create_table(u'root_pageimpression', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authentication.EndUser'], null=True, blank=True)),
        ...
        db.send_create_signal(u'root', ['PageImpression'])


    def backwards(self, orm):
        # Deleting model 'Visitor'
        db.delete_table(u'root_visitor')

        # Deleting model 'PageImpression'
        db.delete_table(u'root_pageimpression')
